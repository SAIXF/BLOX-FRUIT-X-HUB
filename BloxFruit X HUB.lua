...
game.StarterGui:SetCore("SendNotification", {
	Title = "BloxFruit X HUB", 
	Text = "calculate Roblox",
	Icon = "http://www.roblox.com/asset/?id=9610159123",
	Duration = 8
})

local win = library:Window("BloxFruit X HUB",[[ V1]],[[Version : Free ]],"9606070311",Enum.KeyCode.RightControl)
local General_Tab = win:Tab("หน้าหลัก",[[7040391851]])
local Quest_Tab = win:Tab("    เควส & ไอเท่ม",[[9606626859]])
local PvP_Tab = win:Tab("การต่อสู้",[[9606626034]])
local Raid_Tab = win:Tab("ดัน",[[9606629300]])
local Shop_Tab = win:Tab("ช็อป",[[9606625251]])
local Island_Tab = win:Tab("ต่างๆ",[[9606628205]])
local Setting_Tab = win:Tab("ตั้งค่า",[[9606644121]])
local Status_Tab = win:Tab("สถานะ",[[9613645002]])
local Esp_Tab = win:Tab("ค้นหา",[[9606628205]])
local Hop_Tab = win:Tab("ฮอบ",[[9608089732]])
